...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SKILL_CRAFTING = 58,
	CONDITION_PARAM_SKILL_CRAFTINGPERCENT = 59,
	CONDITION_PARAM_SKILL_WOODCUTTING = 60,
	CONDITION_PARAM_SKILL_WOODCUTTINGPERCENT = 61
};
