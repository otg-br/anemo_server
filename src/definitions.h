...
static constexpr auto STATUS_SERVER_NAME = "Anemo";
static constexpr auto STATUS_SERVER_VERSION = "0.0.0 - Based on The Forgotten Server 1.4.2b";
static constexpr auto STATUS_SERVER_DEVELOPERS = "The Forgotten Server Team & miezaF [ANEMO]";
