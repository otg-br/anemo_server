local config = {
    ...
    bossArea = {
        ...
        entrancePos = Position(604, 930, 8), 
        exitPosition = Position(1091, 413, 7) 
    },
    ...
    createTeleportPos = Position(641, 930, 8), 
    teleportToPosition = Position(1091, 413, 7), 
    teleportRemoveSeconds = 100, 
