local config = {
    ...
    bosses = {
        { name = "bone berserker", pos = Position(477, 872, 8) },
        { name = "bone archer", pos = Position(474, 872, 8) },
        { name = "bone mage", pos = Position(488, 874, 8) },
        { name = "bone slicer", pos = Position(492, 875, 8) },
        { name = "bone master", pos = Position(479, 875, 8) }
    }
}
