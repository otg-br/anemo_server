local config = {
    ...
    bossPosition = Position(1825, 918, 12), 
    bossArea = {
        fromPos = Position(1806, 906, 12), 
        toPos = Position(1845, 944, 12), 
        entrancePos = Position(1826, 935, 12), 
        exitPosition = Position(1827, 916, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1827, 915, 11),
        Position(1826, 916, 11),
        Position(1828, 916, 11), 
        Position(1827, 917, 11) 
    },
    attempts = {
        level = 100, 
        storage = 720004, 
    ...
    createTeleportPos = Position(1825, 912, 12), 
    teleportToPosition = Position(1827, 916, 11), 
...
local deepTerror = Action()

function deepTerror.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("deepTerrorDeath")
...
deepTerror:aid(config.actionId)
deepTerror:register()

local creatureEvent = CreatureEvent("deepTerrorDeath")
