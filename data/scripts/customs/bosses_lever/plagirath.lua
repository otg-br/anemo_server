local config = {
    actionId = 30036, 
    bossName = "plagirath",
    bossPosition = Position(443, 245, 11), 
    bossArea = {
        fromPos = Position(429, 235, 11), 
        toPos = Position(454, 257, 11), 
        entrancePos = Position(443, 253, 11), 
        exitPosition = Position(441, 273, 11) 
    },
    ...
    createTeleportPos = Position(442, 237, 11), 
    teleportToPosition = Position(441, 273, 11), 
