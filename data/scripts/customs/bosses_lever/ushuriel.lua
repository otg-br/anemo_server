local config = {
    actionId = 30038, 
    bossName = "ushuriel",
    bossPosition = Position(1326, 275, 13), 
    bossArea = {
        fromPos = Position(1324, 273, 13), 
        toPos = Position(1333, 281, 13), 
        entrancePos = Position(1326, 279, 13), 
        exitPosition = Position(1321, 282, 13) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1320, 284, 13), 
        Position(1320, 283, 13), 
        Position(1320, 282, 13), 
        Position(1320, 281, 13) 
    },
    attempts = {
        level = 100,
        storage = 720002, 
    ...
    createTeleportPos = Position(1332, 274, 13), 
    teleportToPosition = Position(1321, 282, 13), 
