local config = {
    actionId = 43027, 
    bossName = "jaul",
    bossPosition = Position(1722, 1310, 10), 
    bossArea = {
        fromPos = Position(1712, 1301, 10), 
        toPos = Position(1735, 1324, 10), 
        entrancePos = Position(1722, 1321, 10), 
        exitPosition = Position(1681, 1346, 12) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1684, 1345, 12),
        Position(1684, 1346, 12),
        Position(1684, 1347, 12), 
        Position(1684, 1348, 12) 
    },
    attempts = {
        level = 100, 
        storage = 720008, 
    ...
    createTeleportPos = Position(1723, 1305, 10), 
    teleportToPosition = Position(1681, 1346, 12), 
...
local creatureEvent = CreatureEvent("jaulDeath")
