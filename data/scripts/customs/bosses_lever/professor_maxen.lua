local config = {
    actionId = 43023, 
    bossName = "professor maxxen",
    bossPosition = Position(1736, 871, 3), 
    bossArea = {
        fromPos = Position(1726, 861, 3), 
        toPos = Position(1745, 880, 3), 
        entrancePos = Position(1736, 878, 3), 
        exitPosition = Position(1736, 865, 4) 
    },
    ...
    createTeleportPos = Position(1736, 864, 3), 
    teleportToPosition = Position(1736, 865, 4), 
...
local professorMaxxen = Action()

function professorMaxxen.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("professorMaxxenDeath")
...
professorMaxxen:aid(config.actionId)
professorMaxxen:register()

local creatureEvent = CreatureEvent("professorMaxxenDeath")
