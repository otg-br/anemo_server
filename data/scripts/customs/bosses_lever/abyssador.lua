local config = {
    actionId = 43028, 
    bossName = "abyssador",
    bossPosition = Position(1920, 1056, 8), 
    bossArea = {
        fromPos = Position(1900, 1038, 8), 
        toPos = Position(1940, 1082, 8), 
        entrancePos = Position(1919, 1073, 8), 
        exitPosition = Position(1861, 1053, 2) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(1861, 1052, 2),
        Position(1860, 1052, 2),
        Position(1862, 1052, 2), 
        Position(1860, 1053, 2), 
        Position(1861, 1053, 2), 
        Position(1862, 1053, 2), 
        Position(1860, 1054, 2), 
        Position(1861, 1054, 2), 
        Position(1862, 1054, 2), 
    },
    attempts = {
        level = 100, 
        storage = 720009, 
    ...
    createTeleportPos = Position(1919, 1054, 8), 
    teleportToPosition = Position(1861, 1053, 2), 
...
local jaulBoss = Action()

function jaulBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("AbyssadorDeath")
...
jaulBoss:aid(config.actionId)
jaulBoss:register()

local creatureEvent = CreatureEvent("AbyssadorDeath")
